  ...
  if (harga == "") {
    ...
    $.ajax({
      ...
      data: {
        harga: harga,
        stok: stok,
        id_film: "", // Send empty string or nothing, depending on PHP
      },
      success: function (msg) {
        if (msg.trim() == "berhasil") {
          swal("Berhasil !!", "Berhasil Menyimpan Data ", "success");
          $(".content").load("views/tmp_tiket.php");
          $(".bg-thick").fadeOut(500);
        } else {
          swal("Gagal !!", "Gagal Menyimpan Data " + msg, "error");
        }
      },
    });
  }
